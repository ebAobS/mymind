...
<li style="margin: 0.3em 0;"><strong style="color: #ef4444;">🐛 Bug Fixes</strong>
<ul style="margin: 0.2em 0; padding-left: 1em;">
<li>Fixed embedded mind map block reload issue: supports auto-reload after refresh button and document switching</li>
<li>Listen to SiYuan official events for accurate detection</li>
<li>Intelligent throttling mechanism to prevent duplicate loading</li>
</ul>
</li>
</ul>
